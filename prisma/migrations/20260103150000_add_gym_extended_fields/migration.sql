...
ALTER TABLE "Gym" ADD COLUMN IF NOT EXISTS "zipcode" VARCHAR(10);
ALTER TABLE "Gym" ADD COLUMN IF NOT EXISTS "mobileNo" VARCHAR(15);
ALTER TABLE "Gym" ADD COLUMN IF NOT EXISTS "phoneNo" VARCHAR(15);
ALTER TABLE "Gym" ADD COLUMN IF NOT EXISTS "gstRegNo" VARCHAR(20);
